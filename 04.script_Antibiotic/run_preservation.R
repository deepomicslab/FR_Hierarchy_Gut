...
clu_order<-c('S1_C1','S1_C2','S1_C3','S1_C4','S1_C5','S1_C6','S1_C8','S1_C9','S1_C10','S1_C14','S1_C15','S1_C16','S1_C17','S1_C20','S1_C24','S2_C3','S2_C4','S2_C5','S2_C7','S3_C1','S3_C3','S5_C2','S6_C1','S6_C3')
...
pdf(paste(prefix, ".eigengene_cor.",g1,".pdf", sep = ""),width = 6,height = 5)
corrplot(eigen1_filled ,method = 'square', order = 'AOE',  tl.pos = "lt", tl.col = "black", tl.cex = 0.8,  number.cex=0.8, col = COL2("PRGn",10))
dev.off()

pdf(paste(prefix, ".eigengene_cor.",g2,".pdf", sep = ""),width = 6,height = 5)
