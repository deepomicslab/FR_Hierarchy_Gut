...
pred_disc <- read.table('D:/fr_pkg_last/result/immu/SE/pred_disc.tsv', header = TRUE, sep = '\t')
...
ggsave(plt_roc, filename = 'D:/fr_pkg_last/result/immu/SE/fig_roc.pdf', width = 10, height = 10, units = "cm")
...
ggsave(plt_kde_disc, filename = 'D:/fr_pkg_last/result/immu/SE/fig_kde_disc.pdf', width = 10, height = 10, units = "cm")


### 1.6 Prediction in discovery cohort (full signature) ----
pred_disc <- read.table('D:/fr_pkg_last/result/immu/SE/pred_valid.tsv', header = TRUE, sep = '\t')
...
ggsave(fig_km_disc, filename = 'D:/fr_pkg_last/result/immu/SE/fig_km_disc.pdf', width = 10, height = 10, units = "cm")
