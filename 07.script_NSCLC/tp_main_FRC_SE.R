...
### 1.5 Toposcoring ----
pred_disc <- read.table('../result/NSCLC/FRC_SE/pred_disc.tsv', header = TRUE, sep = '\t')
...
ggsave(plt_roc, filename = '../result/NSCLC/FRC_SE/fig_roc.pdf', width = 10, height = 10, units = "cm")
...
ggsave(plt_kde_disc, filename = '../result/NSCLC/FRC_SE/fig_kde_disc.pdf', width = 12, height = 10, units = "cm")


### 1.6 Prediction in discovery cohort (full signature) ----
pred_disc <- read.table('../result/NSCLC/FRC_SE/pred_valid.tsv', header = TRUE, sep = '\t')
...
#ggsave(fig_km_disc, filename = '../result/NSCLC/SE/fig_km_disc.pdf', width = 12, height = 10, units = "cm")
...
GRAPHICS$THEME
ggsave(p, filename = '../result/NSCLC/FRC_SE/result.pdf', width = 12, height = 10, units = "cm")